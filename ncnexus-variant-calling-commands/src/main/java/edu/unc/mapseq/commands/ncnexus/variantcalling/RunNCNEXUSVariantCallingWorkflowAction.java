package edu.unc.mapseq.commands.ncnexus.variantcalling;
...
@Command(scope = "ncnexus-variant-calling", name = "run-workflow", description = "Run NCNEXUS Variant Calling Workflow")
public class RunNCNEXUSVariantCallingWorkflowAction extends AbstractAction {
    ...
    public RunNCNEXUSVariantCallingWorkflowAction() {
        super();
    }
