package edu.unc.mapseq.messaging.ncnexus.variantcalling;
...
public class NCNEXUSVariantCallingMessageListener extends AbstractMessageListener {

    private final Logger logger = LoggerFactory.getLogger(NCNEXUSVariantCallingMessageListener.class);

    public NCNEXUSVariantCallingMessageListener() {
        super();
    }
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            if (workflowList == null || (workflowList != null && workflowList.isEmpty())) {
                logger.error("No Workflow Found: {}", "NCNEXUSVariantCalling");
                return;
            }
