...
import edu.unc.mapseq.workflow.ncnexus.variantcalling.NCNEXUSVariantCallingWorkflow;

public class NCNEXUSVariantCallingWorkflowExecutorTask extends TimerTask {

    private final Logger logger = LoggerFactory.getLogger(NCNEXUSVariantCallingWorkflowExecutorTask.class);

    private final WorkflowTPE threadPoolExecutor = new WorkflowTPE();

    private WorkflowBeanService workflowBeanService;

    public NCNEXUSVariantCallingWorkflowExecutorTask() {
        super();
    }
    ...
    public void run() {
        ...
        try {
            List<Workflow> workflowList = workflowDAO.findByName("NCNEXUSVariantCalling");
            ...
            if (attempts != null && !attempts.isEmpty()) {
                ...
                for (WorkflowRunAttempt attempt : attempts) {
                    ...
                    NCNEXUSVariantCallingWorkflow variantCallingWorkflow = new NCNEXUSVariantCallingWorkflow();
